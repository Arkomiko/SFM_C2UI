...
<tr><td align="center"><a href="../FR-fr/sidebar.md">🇫🇷<br>Français</a></td><td align="center"><b>🇮🇳<br>తెలుగు</b></td><td align="center"><a href="../MR-in/sidebar.md">🇮🇳<br>मराठी</a></td><td align="center"><a href="../TA-in/sidebar.md">🇮🇳<br>தமிழ்</a></td><td align="center"><a href="../TR-tr/sidebar.md">🇹🇷<br>Türkçe</a></td><td align="center"><a href="../UR-pk/sidebar.md">🇵🇰<br>اردو</a></td><td align="center"><a href="../VI-vn/sidebar.md">🇻🇳<br>Tiếng Việt</a></td><td align="center"><a href="../GU-in/sidebar.md">🇮🇳<br>ગુજરાતી</a></td></tr>
...
### <img alt="100%" src="https://img.shields.io/badge/100%25-66c0f4?style=flat-square"> కంటెంట్ ఇండెక్స్

70 199 ఫైళ్లు 1.1 సె కోల్డ్ / 0.02 సె క్యాష్ నుండి; మౌంట్ల మధ్య ఓవర్‌రైడ్‌లు ఇంజిన్ లాగానే పరిష్కరించబడతాయి.

### <img alt="100%" src="https://img.shields.io/badge/100%25-66c0f4?style=flat-square"> మోడల్స్ — <code>.mdl</code> <code>.vvd</code> <code>.vtx</code>

వెర్షన్లు 44, 48, 49. అస్థిపంజరం, మెష్‌లు, అన్ని వివరాల స్థాయిలు, బాడీ గ్రూపులు. 1 500 మోడల్స్ లోడ్, 0 వైఫల్యాలు.

### <img alt="100%" src="https://img.shields.io/badge/100%25-66c0f4?style=flat-square"> మెటీరియల్స్ — <code>.vmt</code>

అన్ని 19 554 మెటీరియల్స్ చదవబడతాయి; `patch`, DX బ్లాక్‌లు, ప్రాక్సీలు.

### <img alt="100%" src="https://img.shields.io/badge/100%25-66c0f4?style=flat-square"> టెక్స్చర్లు — <code>.vtf</code>
...
### <img alt="100%" src="https://img.shields.io/badge/100%25-66c0f4?style=flat-square"> సెషన్లు — <code>.dmx</code>
...
### <img alt="90%" src="https://img.shields.io/badge/90%25-3b9c5b?style=flat-square"> ముఖాలు
...
### <img alt="60%" src="https://img.shields.io/badge/60%25-e0a800?style=flat-square"> రిగ్‌లు
...
### <img alt="60%" src="https://img.shields.io/badge/60%25-e0a800?style=flat-square"> ఎడిటింగ్

క్లిక్ ఎంపిక, మూవ్/రొటేట్ మానిప్యులేటర్, ఏ అట్రిబ్యూట్‌కైనా ఇన్‌స్పెక్టర్, కర్సర్ వద్ద కీ, అన్‌డు/రీడు, బైట్-ఖచ్చిత సేవ్.

### <img alt="50%" src="https://img.shields.io/badge/50%25-e0a800?style=flat-square"> మోషన్ ఎడిటర్

రూలర్‌పై హోల్డ్ మరియు ఫాల్ఆఫ్‌తో సమయ ఎంపిక; ఎడిట్ SFM లాగా దానిపై వ్యాపిస్తుంది. ఇంకా లేదు: ప్రీసెట్లు, లేయర్లు.

### <img alt="70%" src="https://img.shields.io/badge/70%25-3b9c5b?style=flat-square"> గ్రాఫ్ ఎడిటర్
...
### <img alt="80%" src="https://img.shields.io/badge/80%25-3b9c5b?style=flat-square"> ప్యానెల్ డాకింగ్

UE5 మరియు Visual Studio లాగా, ప్రివ్యూతో లక్ష్యాల కంపాస్‌పై ప్యానెల్‌లను లాగండి. ఇంకా లేదు: సేవ్ చేసిన లేఅవుట్లు, థీమ్‌లు.

### <img alt="15%" src="https://img.shields.io/badge/15%25-e07b39?style=flat-square"> Source షేడింగ్
...
### <img alt="0%" src="https://img.shields.io/badge/0%25-555555?style=flat-square"> థీమ్‌లు మరియు వర్క్‌స్పేస్‌లు
