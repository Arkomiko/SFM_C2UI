...
**Als Nächstes**
- Das Aussehen der Karte: Skybox, Wasser, prop_dynamic, Gobo-Texturen der Lichter, `$bumpmap` und `$envmap`, Schatten von Sitzungslichtern.
- Export: Bildsequenzen und Video.
