...
<p align="center">
  ...
  <a href="../../Testing"><img alt="tests" src="https://img.shields.io/badge/%E3%83%86%E3%82%B9%E3%83%88-398-66c0f4?style=flat-square"></a>
...
<p align="center"><img src="../assets/readiness/JA-jp.svg" alt="完成度" width="100%"></p>

<p align="center"><a href="../READINESS/JA-jp.md"><img alt="完成度の詳細" src="https://img.shields.io/badge/%E5%AE%8C%E6%88%90%E5%BA%A6%E3%81%AE%E8%A9%B3%E7%B4%B0-66c0f4?style=for-the-badge"></a></p>
...
5. **エディター**（`App/Code`）はそれをシーン（`render/scene.py`）にまとめ、独自の OpenGL 3.3 レンダラー（`renderer.py`、`shaders.py`）で描きます。セッションのライト、ライトマップ、マップの照明を扱いますが、絵はまだ SFM とは程遠く、作業中です。パネル（`ui/`）はタイムライン、セッションツリー、インスペクター、グラフエディター、UE5 風のドッキングです。
...
**次に**
- マップの見た目：水、prop_dynamic、ライトのゴボテクスチャ、`$bumpmap` と `$envmap`、セッションライトによる影。
- 書き出した動画の音声。
