<p align="center"><img src="../assets/TE-in/banner.png" alt="C2UI" width="100%"></p>
...
<details><summary><img alt="100%" src="https://img.shields.io/badge/100%25-66c0f4?style=flat-square"> <b>మోడల్స్ — <code>.mdl</code> <code>.vvd</code> <code>.vtx</code></b></summary>

వెర్షన్లు 44, 48, 49. అస్థిపంజరం, మెష్‌లు, అన్ని వివరాల స్థాయిలు, బాడీ గ్రూపులు. 1 500 మోడల్స్ లోడ్, 0 వైఫల్యాలు.

</details>
<details><summary><img alt="100%" src="https://img.shields.io/badge/100%25-66c0f4?style=flat-square"> <b>మెటీరియల్స్ — <code>.vmt</code></b></summary>

అన్ని 19 554 మెటీరియల్స్ చదవబడతాయి; `patch`, DX బ్లాక్‌లు, ప్రాక్సీలు.

</details>
<details><summary><img alt="100%" src="https://img.shields.io/badge/100%25-66c0f4?style=flat-square"> <b>టెక్స్చర్లు — <code>.vtf</code></b></summary>
...
<details><summary><img alt="100%" src="https://img.shields.io/badge/100%25-66c0f4?style=flat-square"> <b>సెషన్లు — <code>.dmx</code></b></summary>
...
<details><summary><img alt="0%" src="https://img.shields.io/badge/0%25-555555?style=flat-square"> <b>మ్యాప్‌లు — <code>.bsp</code></b></summary>
...
<details><summary><img alt="0%" src="https://img.shields.io/badge/0%25-555555?style=flat-square"> <b>ప్లగిన్‌లు <code>.c2plg</code></b></summary>
...
<p align="center"><img src="../assets/editor.png" alt="Meet the Heavy తెరిచిన ఎడిటర్" width="100%"><br><sub>నేటి ఎడిటర్, Valve యొక్క Meet the Heavy తెరిచి: టైమ్‌లైన్‌లో షాట్లు మరియు ధ్వని, సెషన్ ట్రీ, మొదటి షాట్ దాని సొంత కెమెరా ద్వారా, సెషన్ ప్రకారం భంగిమలు మరియు ముఖాలతో పాత్రలు.</sub></p>
...
<p align="center"><img src="../assets/models.png" alt="ఇన్‌స్టాలేషన్ నుండి నేరుగా రెండర్ చేసిన 64 మోడల్స్" width="60%"><br><sub>ఇన్‌స్టాలేషన్ నుండి యాదృచ్ఛికంగా ఎంచుకున్న అరవై నాలుగు మోడల్స్, C2UI సొంత రెండరర్‌తో గీసినవి.</sub></p>
