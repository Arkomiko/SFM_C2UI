...
5. **सम्पादक** (`App/Code`) ले यसबाट एउटा दृश्य (`render/scene.py`) बनाउँछ र आफ्नै OpenGL 3.3 रेन्डरर (`renderer.py`, `shaders.py`) ले कोर्छ: सत्रका बत्ती, लाइटम्याप र नक्साको प्रकाश — SFM ले देखाएजस्तै। प्यानलहरू (`ui/`) टाइमलाइन, सत्र ट्री, इन्स्पेक्टर, ग्राफ सम्पादक र UE5 शैलीको डकिङ हुन्।
