...
<p align="center">
  <img alt="paused" src="https://img.shields.io/badge/sviluppo_in_pausa-8a8f98?style=flat-square">
  ...
  <a href="../../Testing"><img alt="tests" src="https://img.shields.io/badge/test-398-66c0f4?style=flat-square"></a>
...
5. **L'editor** (`App/Code`) ne ricava una scena (`render/scene.py`) e la disegna con il proprio renderer OpenGL 3.3 (`renderer.py`, `shaders.py`): luci della sessione, lightmap e illuminazione della mappa — l'immagine è ancora lontana da quella di SFM ed è in lavorazione. I pannelli (`ui/`) sono la timeline, l'albero della sessione, l'inspector, il graph editor e il docking in stile UE5.
...
Si apre il launcher: una finestrella con tre pulsanti. L'aspetto è provvisorio — sarà riscritto quando esisterà App, e la sua finestra è per ora solo in russo.

<p align="center"><a href="../LAUNCHER/IT-it.md"><img alt="Informazioni sul launcher" src="https://img.shields.io/badge/Informazioni_sul_launcher-66c0f4?style=for-the-badge"></a></p>
...
**Prossimamente**
- L'aspetto della mappa: acqua, prop_dynamic, texture gobo delle luci, `$bumpmap` e `$envmap`, ombre dalle luci della sessione.
- L'audio nei filmati esportati.
