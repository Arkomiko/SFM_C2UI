...
<p align="center">
  ...
  <a href="../../Testing"><img alt="tests" src="https://img.shields.io/badge/testes-398-66c0f4?style=flat-square"></a>
...
5. **O editor** (`App/Code`) transforma isso numa cena (`render/scene.py`) e desenha-a com o seu próprio renderizador OpenGL 3.3 (`renderer.py`, `shaders.py`): luzes da sessão, lightmaps e a iluminação do mapa — a imagem ainda está longe da do SFM e continua em trabalho. Os painéis (`ui/`) são a linha de tempo, a árvore da sessão, o inspetor, o graph editor e a ancoragem ao estilo do UE5.
...
Isso abre o lançador: uma janela pequena com três botões. O aspeto é provisório — será reescrito quando existir App, e a janela está por agora só em russo.

<p align="center"><a href="../LAUNCHER/PT-pt.md"><img alt="Sobre o lançador" src="https://img.shields.io/badge/Sobre_o_lan%C3%A7ador-66c0f4?style=for-the-badge"></a></p>
...
**A seguir**
- O aspeto do mapa: água, prop_dynamic, texturas gobo das luzes, `$bumpmap` e `$envmap`, sombras das luzes da sessão.
- Som nos filmes exportados.
