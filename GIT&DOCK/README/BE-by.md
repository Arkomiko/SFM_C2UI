...
<p align="center"><img src="../assets/banner/BE-by.png" alt="C2UI" width="100%"></p>

<p align="center">
  <img alt="paused" src="https://img.shields.io/badge/%D1%80%D0%B0%D1%81%D0%BF%D1%80%D0%B0%D1%86%D0%BE%D1%9E%D0%BA%D0%B0_%D0%BF%D1%80%D1%8B%D0%BF%D1%8B%D0%BD%D0%B5%D0%BD%D0%B0-8a8f98?style=flat-square">
  ...
  <a href="../../Testing"><img alt="tests" src="https://img.shields.io/badge/%D1%82%D1%8D%D1%81%D1%82%D0%B0%D1%9E-398-66c0f4?style=flat-square"></a>
  <img alt="platform" src="https://img.shields.io/badge/Windows-1b2838?style=flat-square&logo=windows&logoColor=white">
  <a href="../LICENSE/BE-by.md"><img alt="licence" src="https://img.shields.io/badge/%D0%BB%D1%96%D1%86%D1%8D%D0%BD%D0%B7%D1%96%D1%8F-C2UI-2a475e?style=flat-square"></a>
</p>
...
> [!IMPORTANT]
> **Распрацоўка прыпынена.** Рэпазіторый застаецца адкрытым: код, дакументацыя і гісторыя на месцы, усё апісанае ніжэй працуе так, як апісана. Лічбы гатоўнасці, issues і дарожная карта адлюстроўваюць стан на момант паўзы.

---

## Гатоўнасць

<p align="center"><img src="../assets/readiness/BE-by.svg" alt="Гатоўнасць" width="100%"></p>

<p align="center"><a href="../READINESS/BE-by.md"><img alt="Гатоўнасць падрабязна" src="https://img.shields.io/badge/%D0%93%D0%B0%D1%82%D0%BE%D1%9E%D0%BD%D0%B0%D1%81%D1%86%D1%8C_%D0%BF%D0%B0%D0%B4%D1%80%D0%B0%D0%B1%D1%8F%D0%B7%D0%BD%D0%B0-66c0f4?style=for-the-badge"></a></p>
...
5. **Рэдактар** (`App/Code`) збірае з гэтага сцэну (`render/scene.py`) і малюе яе ўласным рэндэрарам на OpenGL 3.3 (`renderer.py`, `shaders.py`): святло сесіі, лайтмапы і асвятленне карты — карцінка пакуль далёкая ад SFM і дапрацоўваецца. Панэлі (`ui/`) — таймлайн, дрэва сесіі, інспектар, graph editor, докінг у духу UE5.
...
Адкрываецца акно лаўнчара з трыма кнопкамі. Выгляд у яго часовы — яго перапішуць, калі з'явіцца App; само акно пакуль толькі па-руску.

<p align="center"><a href="../LAUNCHER/BE-by.md"><img alt="Пра лаўнчар" src="https://img.shields.io/badge/%D0%9F%D1%80%D0%B0_%D0%BB%D0%B0%D1%9E%D0%BD%D1%87%D0%B0%D1%80-66c0f4?style=for-the-badge"></a></p>
...
**Бліжэйшае**
- Выгляд карты: вада, prop_dynamic, гобо-тэкстуры святла, `$bumpmap` і `$envmap`, цені ад святла сесіі.
- Гук у экспартаваным відэа.
